...
type App interface {
	...
	GetLog(buildId, logType string, lines int, startTimeStamp string) (string, error)
}
...
func (a AppModel) GetLog(buildId, logType string, lines int, startTimeStamp string) (string, error) {
