...
type FakeStackRepository struct {
	CreateStub        func(params api.StackParams) (createdStack api.Stack, apiErr error)
	...
	UpdateStub        func(id string, params api.StackParams) (target api.Stack, apiErr error)
...
func (fake *FakeStackRepository) Create(params api.StackParams) (createdStack api.Stack, apiErr error) {
...
func (fake *FakeStackRepository) CreateArgsForCall(i int) api.StackParams {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
...
func (fake *FakeStackRepository) Update(id string, params api.StackParams) (target api.Stack, apiErr error) {
...
func (fake *FakeStackRepository) UpdateArgsForCall(i int) (string, api.StackParams) {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
	return fake.updateArgsForCall[i].id, fake.updateArgsForCall[i].params
}

func (fake *FakeStackRepository) UpdateReturns(result1 api.Stack, result2 error) {
	fake.UpdateStub = nil
